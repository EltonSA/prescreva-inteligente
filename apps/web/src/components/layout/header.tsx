...
import { SuggestFeedbackHeaderButton } from '@/components/feedback/suggest-feedback-dialog'
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-14 lg:h-16 bg-base-white border-b border-base-border flex items-center justify-between lg:grid lg:grid-cols-3 px-4 lg:px-[24px]">
      ...
      <div className="flex items-center gap-2 justify-end">
        <SuggestFeedbackHeaderButton />
        <Link
          href="/dashboard/perfil"
          className="flex items-center gap-2 lg:gap-[12px] hover:opacity-80 transition-opacity"
        >
